...
SQL (Junior): "Напиши простой запрос с JOIN двух таблиц"`,
    ...
    RESPONSE_FORMAT: `ОЧЕНЬ ВАЖНО: Твой ответ должен быть СТРОГО валидным JSON-массивом строк.
Никакого текста до или после массива. Никакого Markdown форматирования (без \`\`\`json).
Только сам массив.
