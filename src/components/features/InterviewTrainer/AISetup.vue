<template>
  <div class="ai-setup">
    ...
    <a-form layout="vertical" class="ai-settings-form">
        ...
        <a-col :span="8">
          <a-form-item label="Количество вопросов" required>
            <a-select v-model:value="aiSettings.questionsCount" size="large">
              <a-select-option value="5">5 вопросов</a-select-option>
              <a-select-option value="10">10 вопросов</a-select-option>
              <a-select-option value="15">15 вопросов</a-select-option>
              <a-select-option value="20">20 вопросов</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
      </a-row>
      ...
      <a-form-item label="Технология" v-if="showTechnologySelect">
